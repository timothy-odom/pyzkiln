...
class Alu:
    ...
    def run(self, prof_name,parms):
        self.racf.log.debug('Alu run')

        proc = subprocess.run(['./ALU.REXX',prof_name,parms],cwd=PY_REXX+'/R_admin/python/REXX',capture_output=True,text=False)
        return proc
